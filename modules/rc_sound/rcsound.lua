...
SOUNDS = {
	-- Saffron --
	{fromPos = {x=1052, y=1052, z=2}, toPos = {x=1058, y=1052, z=7}, priority = 10, sound="Route 2.ogg"},	-- Everywhere
	{fromPos = {x=1052, y=1051, z=2}, toPos = {x=1058, y=1051, z=7}, priority = 2, sound="Route 2.ogg"},	-- Everywhere
	{fromPos = {x=1052, y=1050, z=2}, toPos = {x=1063, y=1050, z=7}, priority = 2, sound="Route 2.ogg"},	-- Everywhere
	{fromPos = {x=1052, y=1049, z=2}, toPos = {x=1065, y=1049, z=7}, priority = 2, sound="Route 2.ogg"},	-- Everywhere
	{fromPos = {x=1052, y=1048, z=2}, toPos = {x=1065, y=1048, z=7}, priority = 2, sound="Route 2.ogg"},	-- Everywhere
	{fromPos = {x=1052, y=1047, z=2}, toPos = {x=1065, y=1047, z=7}, priority = 2, sound="Route 2.ogg"},	-- Everywhere
	{fromPos = {x=1052, y=1046, z=2}, toPos = {x=1065, y=1046, z=7}, priority = 2, sound="Route 2.ogg"},	-- Everywhere
	{fromPos = {x=1052, y=1045, z=2}, toPos = {x=1065, y=1045, z=7}, priority = 2, sound="Route 2.ogg"},	-- Everywhere
	{fromPos = {x=1052, y=1044, z=2}, toPos = {x=1065, y=1044, z=7}, priority = 2, sound="Route 2.ogg"},	-- Everywhere
	{fromPos = {x=1052, y=1053, z=2}, toPos = {x=1056, y=1053, z=7}, priority = 2, sound="Route 2.ogg"},	-- Everywhere
